  ...
  class Load {
    ...
    createRuleText() {
      ...
      if (this._page === 1) {
        ...
        sentenceText.push(
          `チップやベット・アンティ・フォールドなどのない簡易なポーカーになります。<br>
      ...
      if (this._page === 2) {
        ...
        sentenceText.push(
          `「カードを配る」ボタンをクリックすると、すべてのプレイヤーにカードが 5 枚ずつ配られます。<br><br>
      ...
      if (this._page === 4) {
        ...
        sentenceText.push(
          `手札から不要なカードをクリックすると、クリックしたカードが少し上に移動します。<br>
      ...
      // ８ページ目
        ...
        sentenceText.push(
          `ポーカーの役が強いほど、高い順位が割り当てられます。<br><br>
      ...
      // ９ページ目
        ...
        sentenceText.push(
          `「 A 2 3 4 5 」  これはストレートになります。この場合 A が最も弱くなります。<br><br>
  ...
  class Poker {
    ...
    public constructor() {
      ...
      setTimeout(() => {
        ...
        const startPokerBtn = document.querySelector<HTMLDivElement>('.startPokerBtn');
